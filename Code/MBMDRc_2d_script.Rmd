...
result_path = "C:/Users/fmelo/Documents/Github/MBMDRc_R/Result/"

# args = commandArgs(trailingOnly=TRUE)
p_threshold <- 0.05# as.numeric(args[1]) #i.e., 0.95
is_0_considered <- "0" # args[2]  # 0 = considered ; 1 Not_considered
...
saveRDS(risk_2d, file = paste0("GOLA_Myrisk_",p_threshold,"with",is_0_considered,".rds"))



result_df <- data.frame(risk_2d, data) 
print(result_df[1:5,1:5])
